...
var createTaskEl = function(taskDataObj) {
    ...
    // add task id and draggable as custom attributes
...
var dropZoneDragHandler = function(event) {
  ...
  if (taskListEl) {
    event.preventDefault();
    taskListEl.setAttribute("style", "background: rgba(68, 233, 255, 0.7); border-style: dashed; box-shadow: none;");
  }
};
...
var loadTasks = function() {
  ...
  for (i=0; i < tasks.length; i++) {
    ...
    // Note: this function is not working properly, as it is loading saved data into the console log but not onto the page.
